export function Logo() {
    return (
        <svg version="1.2" viewBox="0 0 493 167" width="128">
            <title>encord 2 02 -svg</title>
            <style></style>
            <g id="Layer">
                <g id="Layer">
                    <path
                ...
                <g id="Layer">
                    <path
                        id="Layer"
                        className="s0"
                        d="m163.6 44.5v78h-5.9l-50.6-64.5v64.5h-7.4v-78h6l50.6 64.6v-64.6z"
                    ></path>
                </g>
                <g id="Layer">
                    <path
                ...
                <g id="Layer">
                    <path
                        ...
                        fillRule="evenodd"
                        className="s0"
                        d="m407.1 122.5h-8.5l-18.2-25.4q-3.7 0.5-7 0.5h-20.8v24.9h-7.4v-78h28.2c9.8 0 17.6 2.4 23.2 7c5.6 4.7 8.4 11.3 8.4 19.6c0 6.2-1.6 11.5-4.8 15.7c-2.9 4-7.1 6.9-12.5 8.7zm-15.6-66.1c-4.1-3.4-10.1-5.2-18-5.2h-20.9v39.6h20.9c7.9 0 13.9-1.7 18-5.1c4.1-3.4 6.2-8.4 6.2-14.7c0-6.3-2.1-11.2-6.2-14.6z"
                    ></path>
                </g>
                <g id="Layer">
                    <path
